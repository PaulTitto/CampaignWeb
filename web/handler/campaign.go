...
func (h *campaignHandler) CreateImage(c *gin.Context) {
	...
	userCamapign, err := h.userService.GetUserByID(userId)
	if err != nil {
		c.HTML(http.StatusInternalServerError, "error.html", nil)
		return
	}
	createCampaignImageInput.User = userCamapign
...
func (h *campaignHandler) Update(c *gin.Context) {
	...
	_, err = h.campaignService.UpdatedCampaign(campaign.GetCampaignDetailInput{ID: id}, updateInput)
	if err != nil {
		c.HTML(http.StatusInternalServerError, "error.html", nil)
		return
	}
